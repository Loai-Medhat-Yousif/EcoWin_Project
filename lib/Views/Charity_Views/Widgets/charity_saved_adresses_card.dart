...
class CharitySavedAdressesCard extends StatelessWidget {
  ...
  final String pieces;
  final int id;
  final List<File> charityimageslist;
  CharitySavedAdressesCard({
    Key? key,
    ...
    required this.id,
    required this.charityimageslist,
  }) : super(key: key);
  @override
          ...
          Row(
            children: [
              ...
              ElevatedButton(
                ...
                onPressed: () {
                  context.read<SavedadressesCubit>().sendCharityOrder(
                      governate,
                      city,
                      streetadress,
                      buildnumber,
